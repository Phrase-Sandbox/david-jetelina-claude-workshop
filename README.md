...
**Duration:** ~50 minutes, interactive
...
| 17 min | [Exercise 3: Skills](exercises/03-skills/) | Read a real skill, watch it run, write your own |
...
3. **Skills are team recipes.** Any repeated workflow can be a markdown file Claude follows.
